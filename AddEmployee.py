from pymupdf import swig_version
...
class AddEmployee(BasePage):
    ...
    disabled_radio_button = (By.XPATH,"//label[normalize-space()='Disabled']")
    emp_id_input_box = (By.CSS_SELECTOR,"div[class='oxd-input-group oxd-input-field-bottom-space'] div input[class='oxd-input oxd-input--active']")
    ...
    def add_name(self,firstname = "cleanuptest_" + str(uuid.uuid4().hex[:6]), middlename = None, lastname = None):
        ...
        self.wait_and_sendkeys(self.emp_id_input_box, f"{str(uuid.uuid4().hex[:6])}" )
    ...
    def button_click_disabled(self):
        self.direct_click(self.disabled_radio_button)
